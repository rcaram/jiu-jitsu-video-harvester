...
// Get Clerk publishable key from environment variables or use the provided one
const PUBLISHABLE_KEY = import.meta.env.VITE_CLERK_PUBLISHABLE_KEY || "pk_test_dGlkeS1lZnQtNjEuY2xlcmsuYWNjb3VudHMuZGV2JA";
